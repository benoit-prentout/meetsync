...
useSettingsStore.setState({
  ...
  history: [
    ...
    { id: 'h5', timestamp: new Date(now - 7 * day).toISOString(), filesProcessed: 2, status: 'success', message: 'Synced 2 meeting notes' },
    { id: 'h6', timestamp: new Date(now - 8 * day).toISOString(), filesProcessed: 0, status: 'error', message: 'Failed: quota exceeded' },
    { id: 'h7', timestamp: new Date(now - 10 * day).toISOString(), filesProcessed: 4, status: 'success', message: 'Synced 4 meeting notes' },
    { id: 'h8', timestamp: new Date(now - 12 * day).toISOString(), filesProcessed: 2, status: 'success', message: 'Synced 2 meeting notes' },
  ],
  files: [
